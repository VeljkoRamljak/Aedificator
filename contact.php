                    ...
                    <div class="col-sm-4 sm-margin-b-50">
                        <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".3s">
                            ...
                            <p> Močići 39, 
								...
								HR</p>
                            <ul class="list-unstyled contact-list">
                                <li><i class="margin-r-10 color-base icon-call-out"></i> +385 99 8274-571</li>
                                <li><i class="margin-r-10 color-base icon-envelope"></i> miroslav.bego.aedif@gmail.com</li>
                            </ul>
                        </div>
                    </div>
                    <!-- End Contact List -->
